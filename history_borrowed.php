...
<body>
    ...
    <main>
        ...
        <div class="categories">
            ...
            <button onclick="window.location='history_borrowed.php'" class="category active">Borrowed</button>
            <button onclick="window.location='history_cancelled.php'" class="category">Cancelled</button>
        </div>
        ...
        <div style="overflow-x:auto;">
            <table>
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM borrow_tbl WHERE student_id = '$student_id' AND status = 'Borrowed' ORDER BY borrow_id DESC";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td class='td'><span class='btn btn-primary'>" . htmlspecialchars($row["status"], ENT_QUOTES, 'UTF-8') . "</td>";
                            // echo "<td>
                            //         <button 
