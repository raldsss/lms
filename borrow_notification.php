...
<body>
    ...
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            ...
            <li>
                ...
                <span id="notification-count" class="badge bg-danger text-white" style="margin-left: 5px; display: none;">0</span>
            </li>
            <li>
    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <span class="text">BORROW NOTIFICATION</span>
        </div>
        <div class="button">
        ...
        <div class="table-container">
                <table id="myTable">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM borrow_tbl WHERE status = 'Pending' ORDER BY borrow_id DESC";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                if ($row["status"] == 'Pending') {
                                    echo "<td><button class='btn btn-success btn-approve' onclick='approveBook(" . $row['borrow_id'] . ")'>APPROVE</button></td>";
                                    echo "<td><button class='btn btn-danger btn-cancel' onclick='cancelBook(" . $row['borrow_id'] . ")'>CANCEL</button></td>";
                                } elseif ($row["status"] == 'Borrowed') {
                                    echo "<td><span class='badge bg-success'>Borrowed</span></td>";
                                    echo "<td></td>";
    ...
    <script src="js/borrow_notification.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</body>
</html>